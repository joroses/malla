...
def main():
    ...
    try:
        ...
        # Warm the caches before serving: refresher threads compute the
        # analytics dashboard and /api/locations payloads now and keep
        # them fresh in the background, so no visitor ever waits inside
        # a compute window.
